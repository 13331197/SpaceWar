...
public class DoneEnemy : MonoBehaviour
{
	// Enemy moving properties
	...
	public void InstansSpeedPos ()
	{
		...
		this.transform.localScale+=new Vector3(Random.Range(3.0f,5.0f),Random.Range(3.0f,5.0f),Random.Range(3.0f,5.0f));
	}
}
